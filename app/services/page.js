...
const ServicePage = () => {
    return (
        <>
            ...
            >
                <div className="flex flex-col md:flex-row items-center justify-center max-w-screen-xl mx-auto py-12 text-center space-y-12 md:space-x-12 px-6 fade-in-head ">
