        ...
        <section id="whycompany" className="py-12 px-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p>
                        AEKOT empowers customer service teams with Salesforce Agentforce solutions that streamline workflows, enhance automation, and create intelligent, data-driven support operations.
                    </p>
                </motion.div>
